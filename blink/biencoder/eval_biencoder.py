...
def encode_candidate(
    ...
    # Nhat: Shape (num_candidates, embedding_dim)
...
def main(params):
    ...
    # Type: tensor of shape (# entities, embedding_dim)
    ...
    # A list of dictionary objects (from .jsonl file)
    ...
    # test_tensor_data is a Dataset object (context ids, cand ids, label ids)
    # test_data is a dictionary object (context, cand, label)
    ...
    if save_results: 
        save_data_dir = os.path.join(
            params['output_path'],
            "top%d_candidates_pretrained_original_def_64" % params['top_k'],
        )
